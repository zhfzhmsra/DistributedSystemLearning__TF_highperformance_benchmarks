...
def aggregate_gradients_using_copy_with_variable_colocation(
  ...
  for i in range(len(tower_grads[0])):
    print (tower_grads[0][i][0].device, tower_grads[1][i][0].device
           ,tower_grads[0][i][1].device, tower_grads[1][i][1].device)
...
def aggregate_gradients_using_copy(tower_grads, use_mean):
  ...
  for i in range(len(tower_grads[0])):
    print (tower_grads[0][i][0].device, tower_grads[1][i][0].device
           ,tower_grads[0][i][1].device, tower_grads[1][i][1].device
           ,tower_grads[0][i][1]._caching_device, tower_grads[1][i][1]._caching_device)
